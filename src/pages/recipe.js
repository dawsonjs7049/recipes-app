...
export default function recipe() {
    ...
    return (
        <div className="pb-10">
            <div className="dark:bg-slate-200 w-full max-w-xl my-10 p-4 md:p-12 shadow-lg rounded-lg mx-auto">
                <form>
                    ...
                    <div className="py-2">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col md:flex-row md:justify-between items-center mt-4 gap-2">
                                <input value={ingredient} onChange={(e) => setIngredient(e.target.value)} className="w-full md:w-3/5 shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Ingredient" />
