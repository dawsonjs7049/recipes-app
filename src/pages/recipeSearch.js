    ...
    return (
        <div className="w-full">
            ...
            <div className="w-full text-center mt-10 mb-5 flex flex-row justify-center items-center gap-2">
                <input value={searchInput} onChange={(e) => setSearchInput(e.target.value)} onKeyDown={(e) => handleEnterCheck(e)} className="w-3/4 md:w-96 shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Search By Name" />
